@fragment('download')
    <a href="{{$file_path ?? ""}}" download="{{$file_name ?? ""}}" class="btn btn-primary p-0"
    _="on click toggle my *display">
        <span data-bs-dismiss="modal" class="d-block py-1 px-4">Download</span>
    </a>
@endfragment
@fragment('error')
    <p class="text-black">
